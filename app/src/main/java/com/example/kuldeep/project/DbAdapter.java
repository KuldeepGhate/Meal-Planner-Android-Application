...
/**
 * Created by prajakta on 2/20/15.
 */
public class DbAdapter {
    ...
    public static final String CREATE_RECIPE_TABLE = "create table recipe (recipe_id integer not null primary key autoincrement unique, " + "recipe_name text not null, recipe_path text not null,recipe_procedure text not null);";
    ...
    public long insertRecipe(String recipe_name, String recipe_image_path, String recipe_procedure) {
